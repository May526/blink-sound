...
from ozyamamushi.utils.lightning_utils import (
    prepare_lightning_datamodule,
    prepare_lightning_trainer,
)
from ozyamamushi.utils.logger import get_logger
from ozyamamushi.utils.module_utils import instantiate
...
@hydra.main(
    config_path="../configs", config_name="default_lightning.yaml", version_base="1.3"
)
def main(config: DictConfig):
    from ozyamamushi.utils import extras
